    ...
    <>
      <section className="box-container h-full w-full py-20">
        <div className="flex md:flex-row flex-col items-center md:items-start gap-8">
          ...
          />
          <div className="flex flex-col self-start gap-2 justify-start items-start ">
            ...
            <div className="flex items-center   gap-2">
              <span className="font-semibold text-gray-800">عدد الصفحات</span>
              <span className="text-gray-600">{Book.book_number}</span>
            </div>
          </div>
        </div>
      </section>
