          ...
          <div className="w-full mt-12">
            <div className="flex flex-wrap gap-2">
              {article.tags.reverse().map((tag, index) => (
                <span
                  key={index}
                  className="inline-flex items-center px-2.5 py-1 text-xs font-medium bg-white/60 text-gray-800 border border-gray-200 hover:bg-white/80 transition-colors cursor-pointer"
                >
                  {tag}
                </span>
              ))}
