...
const ServicesGrid = () => {
  const services = [
    ...
    },
    {
      ...
      title: "القوانين",
      description:
        "حزمة من النصوص القانونية واللوائح المتعلقة بالمحكمة العليا، إضافةً إلى مختاراتٍ من أهمّ التشريعات في العملية القضائية",
          ...
          {services.map((service) => (
            ...
            >
              <div className="p-8 text-center">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-gray-800 dark:text-foreground mb-4 group-hover:text-main transition-colors duration-300">
                  {service.title}
                </h3>
