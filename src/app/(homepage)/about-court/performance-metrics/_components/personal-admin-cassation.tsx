...
export default function PersonalAdminCassation() {
  const [selectedYear, setSelectedYear] = useState(2013);
  const sampleData: YearlyData = {
    2012: { percentage: 73, title: "دوائر الأحوال الشخصية والإداري" },
    2013: { percentage: 76, title: "دوائر الأحوال الشخصية والإداري" },
    2014: { percentage: 83, title: "دوائر الأحوال الشخصية والإداري" },
    2015: { percentage: 90, title: "دوائر الأحوال الشخصية والإداري" },
    2016: { percentage: 89, title: "دوائر الأحوال الشخصية والإداري" },
  };
