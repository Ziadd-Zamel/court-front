  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          "select-none font-medium text-slate-700 dark:text-gray-200",
          captionLayout === "label"
            ? "text-sm"
        ...
        weekday: cn(
          "text-slate-400 dark:text-gray-500 rounded-md flex-1 font-normal text-[0.8rem] select-none",
        ...
        week_number: cn(
          "text-[0.8rem] select-none text-slate-400 dark:text-gray-500",
        ...
        today: cn(
          "bg-slate-100 dark:bg-gray-700 text-slate-900 dark:text-gray-100 rounded-md data-[selected=true]:rounded-none",
          defaultClassNames.today,
        ),
        outside: cn(
          "text-slate-300 dark:text-gray-600 aria-selected:text-slate-300 dark:aria-selected:text-gray-600",
