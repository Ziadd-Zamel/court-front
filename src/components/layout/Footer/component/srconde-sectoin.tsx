  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="flex flex-col justify-start gap-5">
        <h2 className="mb-5 text-2xl font-bold text-main text-right">
          الاتصال
        </h2>
        <h4 className="text-main font-medium text-lg">طرابلس</h4>
        <div className="flex items-center gap-3">
          <FaLocationDot className="text-main" />
          <p className="text-base">طرابلس – زاوية الدهماني</p>
        </div>
        <div className="flex items-center gap-3">
          <FaPhone className="text-main" />
          <p style={{ direction: "ltr" }} className="text-base mr-1.5">
            +218-21-3403725/27
          </p>
        </div>
      </div>
      <div className="flex flex-col justify-start mt-8 gap-5">
        ...
        <div className="flex items-center gap-3">
          <FaLocationDot className="text-main" />
          <p className="text-base">شارع رفيق المهدوي</p>
        </div>
        <div className="flex items-center gap-3">
          <FaPhone className="text-main" />
          <p style={{ direction: "ltr" }} className="text-base mr-1.5">
